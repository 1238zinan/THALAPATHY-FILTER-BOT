...
URL = "https://thala-qt1d.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://thala-qt1d.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://thala-qt1d.onrender.com/".format(FQDN)
else:
    URL = "http://thala-qt1d.onrender.com/".format(FQDN)
